...
def gerar_imagem(dados, template_path="TAMPLATE PROPOSTA.jpg"): 
    ...
    # --- CORREÇÃO DAS FONTES ---
    # Agora definimos todas as fontes no início com proteção contra erro
    try:
        ...
        font_small_bold = ImageFont.truetype("arialbd.ttf", 20) # Fonte corrigida
    except OSError:
        # Se não achar Arial, usa a padrão do sistema
